...
@rem set ORG_GRADLE_PROJECT_MAVEN_REPO=http://nexus.statkart.no:8090/nexus/content/groups/public/
...
@rem set ORG_GRADLE_PROJECT_REPO_UPLOAD_RELEASES=http://nexus.statkart.no:8090/nexus/content/repositories/releases/
...
@rem set ORG_GRADLE_PROJECT_REPO_UPLOAD_SNAPSHOTS=http://nexus.statkart.no:8090/nexus/content/repositories/snapshots/
