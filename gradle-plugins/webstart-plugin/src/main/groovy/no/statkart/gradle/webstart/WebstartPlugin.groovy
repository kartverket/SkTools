package no.statkart.gradle.webstart
...
class WebstartPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        project.convention.plugins.put('webstart', convention)
        project.plugins.apply(JavaPlugin.class);
        Configuration moduleConfiguration = project.configurations.add('webstart').setDescription("Classpath for jars to be included in webstart application");
