...
abstract class AbstractDatabaseConvention {
    ...
    public String getTaskName(String target) {
        ...
        //kan ikke bruke toLowerCamelCase(prefix + ' ' + target) da target kan inneholde "." og andre spesialtegn (ikke anbefalt, men støttet)
        if (prefix != null && !prefix.isEmpty()) {
            return Utils.toLowerCamelCase(prefix) + capitalize(target);
        } else {
